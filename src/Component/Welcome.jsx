  ...
  return (
    <div className='grid grid-col-1 md:grid-cols-4 gap-4 p-6 my-16 mx-auto w-11/12 text-center bg-white dark:bg-stone-300'>
      ...
      <div className='col-span-2  font-mono flex flex-col items-center justify-center '>
        <h2 className='text-cyan-600 text-lg lg:text-xl '>-- WELCOME --</h2>
        <h1 className='text-2xl  lg:text-3xl my-3 lg:my-6'>Dine at DineFlow</h1>
        <h3 className='text-lg lg:text-xl text-gray-700'>"Step into a world where every dish is a masterpiece. At DineFlow, we blend taste, ambiance, and passion to craft unforgettable dining experiences."</h3>
