    ...
    <div className="bg-gray-100 dark:bg-gray-900">
      ...
      >
        <div className="bg-black/60 px-6 py-10 rounded-xl text-center max-w-2xl text-white shadow-lg">
          <h2 className="text-3xl md:text-5xl font-bold mb-4 font-mono tracking-wide">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <h3 className="text-2xl md:text-3xl font-bold text-center mb-10 text-gray-800 font-mono dark:text-gray-200">-- Top Picks --</h3>
